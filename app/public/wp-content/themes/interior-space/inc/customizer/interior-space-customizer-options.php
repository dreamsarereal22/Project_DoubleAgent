	...
	$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';	
		...
		$wp_customize->add_setting(
			...
			array(
				...
				'default' => __('Copyright &copy; 2024 | Powered by <a href="//wordpress.org/">WordPress</a> <span class="sep"> | </span> Interior Space theme by <a target="_blank" href="//themearile.com/">ThemeArile</a>', 'interior-space'),
